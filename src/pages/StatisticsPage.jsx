      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-2xl font-bold text-gray-800">{dailyGoalStats.achievementRate}%</span>
          </div>
          <div className="text-sm text-gray-500">Daily Goal Success</div>
          <div className="text-xs text-gray-400 mt-1">
            {dailyGoalStats.achievedDays} of {dailyGoalStats.totalDays} days
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="text-center">
            <div className="text-3xl font-bold text-indigo-600">{dailyGoalStats.currentStreak}</div>
            <div className="text-sm text-gray-500">Current Streak</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-green-600">{dailyGoalStats.recentRate}%</div>
            <div className="text-sm text-gray-500">Last 7 Days</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-blue-600">{dailyGoalStats.achievementRate}%</div>
              ...
              return (
                <div key={day.date} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 bg-gray-200 rounded-full h-6 relative">
                    <div 
                      className={`h-6 rounded-full flex items-center justify-center text-xs font-medium ${
                        day.achieved ? 'bg-green-500 text-white' : 'bg-blue-500 text-white'
                      }`}
                  ...
                  <div className="w-16 text-xs text-gray-500 text-right">
                    {Math.round(day.actualMinutes / 60 * 10) / 10}h
                  </div>
                  {day.achieved && (
